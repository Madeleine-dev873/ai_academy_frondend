...
function App() {
  const coursesData = [
    ...
    { id: 3, title: "Deep Learning Avancé", description: "Maîtrisez les réseaux de neurones.", price: 399, level: "Avancé" },
    { id: 4, title: "IA et Éthique", description: "Explorez les implications éthiques.", price: 249, level: "Tous niveaux" }
  ];
